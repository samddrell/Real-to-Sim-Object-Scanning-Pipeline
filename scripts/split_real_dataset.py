#!/usr/bin/env python
"""
Split bottle01 real dataset into train/val for YOLO.
...
Creates:
  ...
  data/bottle01/images/train/
  data/bottle01/images/val/
  data/bottle01/labels/train/
  data/bottle01/labels/val/

and moves each image + its label into the appropriate split.

You can adjust the TRAIN_FRACTION below.
"""
...
# Name of the dataset folder under data/
DATASET_NAME = "bottle01"
...
def main():
    # Resolve repo root as the parent of the 'scripts' folder
    ...
    if not image_files:
        ...
        print("Make sure your 54 real images are directly under 'images/', "
